 ...
 */
 ...
 const html = fs.readFileSync(path.resolve(__dirname, 'myblog.html'), 'utf8'); /* GET THIS RIGHT */
 ...
 describe('post.html testing follows:', () => {
    ...
    describe(' ------  Body examination:  ------', () => {
        ...
        test('blog navbar link present', () => {
            ...
            expect(seeLinks[3].outerHTML).toContain('myblog.html');
        })
        ...
        test('are H1 contents as expected', () => {
            let h1 = document.querySelector('h1');
            expect(h1.textContent).toEqual('Time to open up');
        })
